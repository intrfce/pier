...
class AddCommand extends Command
{
     ...
     * @var string
     */
    protected $description = 'Add a service to an existing Pier installation';
    ...
    public function handle()
    {
        ...
        $this->output->writeln('');
        $this->components->info('Additional Pier services installed successfully.');
    }
}
